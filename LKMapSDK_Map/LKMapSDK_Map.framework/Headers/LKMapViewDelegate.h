 ...
 * @return 是否允许选中标注
 */
- (BOOL)mapView:(LKMapView *)mapView shapeAnnotationIsEnabled:(LKShape *)annotation;
 ...
 */
- (void)mapView:(LKMapView *)mapView didSelectAnnotation:(id <LKAnnotation>)annotation;
 ...
 */
- (void)mapView:(LKMapView *)mapView didDeselectAnnotation:(id <LKAnnotation>)annotation;
